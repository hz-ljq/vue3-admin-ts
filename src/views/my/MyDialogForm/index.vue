    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <template v-if="stepsActive === 0">
          <el-button type="primary" size="small" @click="stepPlus"
            >下一步</el-button
          >
        </template>
